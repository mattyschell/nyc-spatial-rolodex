...
This appears to be extracted from the Department of Information Technology and Telecommunications (DoITT) Street Centerline (CSCL) database. 
...
Click down at the end to accept the terms and good luck.  Data feeds are in General Transit Feed Specification (GTFS) format.  https://developers.google.com/transit/gtfs/
